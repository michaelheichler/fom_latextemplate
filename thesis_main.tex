...
%-----------------------------------
% Tabellen- und Abkürzungsverzeichnis stehen in der Regel nicht im Inhaltsverzeichnis. Auch gilt dass für das Abkürzungsverzeichnis (siehe unten).
% Falls Dozenten dies trotzdem Verlangen gibt die Option
% 'listof=totoc,bibliography=totoc'
% gibt das Tabellen- und Abkürzungsverzeichnis im Inhaltsverzeichnis (toc=Table
% of Content) aus.
...
% Dokumentensprache
% Über Shell Kompilierung kann mit dem Zusatz -en die Sprache der Thesis auf Englisch umgestellt werden.
% e.g. compile.sh -en
\newif\ifde
\newif\ifen
...
\begin{titlepage}
	...
	\begin{center}
		...
		\textbf{
				...
				\langen{for attainment of the academic degree of}
				}\\
				\textbf{\myAkademischerGrad}\\
				\textbf{\langen{presented by}}\\
				\textbf{\langen{Michael Heichler}}\\
...
% Für weitere Kapitel bitte auskomentieren und darauf achten dass das tex File vom jeweiligen Kapitel im Ordner liegt.
...
% Sperrvermerk - Wichtig und muss bei jeder Thesis mit eingefügt werden
